...
namespace Resources
{
    public static class ResourceManager
    {
        ...
        public static T GetResourceWidget<T, THandler>(string path, Stylesheet? stylesheet = null, THandler? handler = null, ITypeResolver? typeResolver = null) where T : Widget where THandler : class
        {
